...
if (isset($_POST['signup'])) {
    ...
    if (empty($user_name) || empty($user_email) || empty($user_phone) || empty($user_password) || empty($user_confirm_password)) {
        ...
        if ($stmt->execute()) {
            ...
            $err = "Error: Unable to register user.";
        }
        $stmt->close();
    }
}
...
<head>
    ...
    <title>Signup - Blackout Esports</title>
...
<body>
    ...
    <div class="container">
        <div class="signup-container">
            <div class="user-badge">NEW PLAYER</div>
            <div class="logo">
                ...
                <div class="form-section">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="user_name" class="form-control" value="" id="username"
                ...
                <div class="form-check mb-3">
                    ...
                    <label class="form-check-label" for="termsCheck">
                        I agree to the <a href="#" data-bs-toggle="modal" data-bs-target="#termsModal">Terms of
                            Service</a> and <a href="#" data-bs-toggle="modal" data-bs-target="#privacyModal">Privacy
                            Policy</a>
                    </label>
