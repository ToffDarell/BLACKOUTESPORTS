                ...
                <div class="col-lg-10">
                    ...
                    <div class="history-container animate__animated animate__fadeIn">
                        ...
                        <div class="alert alert-info mb-4" style="background-color: #1d1d1d; border-color: #3d5a80; color: #edf2f4;">
                            ...
                            <strong>System Notice:</strong> The 'total_amount' column was automatically added to the reservations table. All existing reservations have a default amount of â‚±0.00. Please update them with actual amounts if needed.
                        </div>
                        <?php endif; ?>
                                    ...
                                    <div class="reservation-details">
                                        ...
                                        <div class="reservation-payment">
                                            <?php if ($reservation['status'] === 'Refunded'): ?>
                                                <span class="text-white">Amount: â‚±<?php echo isset($reservation['total_amount']) ? number_format($reservation['total_amount'], 2) : '0.00'; ?> (refunded)</span>
                                            <?php else: ?>
                                                <span class="text-white">Amount: â‚±<?php echo isset($reservation['total_amount']) ? number_format($reservation['total_amount'], 2) : '0.00'; ?></span>
                                            <?php endif; ?>
