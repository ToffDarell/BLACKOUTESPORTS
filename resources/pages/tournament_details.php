            ...
            <div class="row">
                ...
                <div class="col-lg-8 animate__animated animate__fadeInLeft">
                    ...
                    <div class="tournament-info-box">
                        ...
                        <div class="tournament-stats">
                            ...
                            <div class="stat-item">
                                ...
                                <div class="stat-value">â‚±<?php echo number_format($tournament['entry_fee']); ?></div>
                    ...
                    <div class="tournament-info-box">
                        ...
                        <?php $clean_prize_pool = floatval(str_replace(['$', 'â‚±', ','], '', $tournament['prize_pool'])); ?>
                        <div class="prize-badge"><i class="fas fa-medal"></i> 1st Place: â‚±<?php echo number_format($clean_prize_pool * 0.6); ?></div>
                        <div class="prize-badge"><i class="fas fa-medal"></i> 2nd Place: â‚±<?php echo number_format($clean_prize_pool * 0.3); ?></div>
                        <div class="prize-badge"><i class="fas fa-medal"></i> 3rd Place: â‚±<?php echo number_format($clean_prize_pool * 0.1); ?></div>
                        
                        <div class="mt-3">
                            <p><strong>Total Prize Pool:</strong> â‚±<?php echo number_format($clean_prize_pool); ?></p>
