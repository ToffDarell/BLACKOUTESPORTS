...
<head>
    ...
    <link rel="stylesheet" href="/css/manage_reservations.css">
    <style>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/admin/refunds">Refunds</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/admin/tournaments">Tournaments</a>
                        </li>
                        <li class="nav-item">
