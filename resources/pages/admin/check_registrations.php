...
while ($row = $result->fetch_assoc()) {
    ...
    echo "<td><a href='/admin/tournaments/registrations/check?tournament_id=" . $row['id'] . "'>View Registrations</a></td>";
    echo "</tr>";
}
echo "</table>";
...
if ($tournament_id > 0) {
    ...
    if ($tournament) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($tournament['registered_teams'] != $result->num_rows) {
                ...
                echo "<p><a href='/admin/tournaments/registrations/check?tournament_id=$tournament_id&fix=1'>Fix the count</a></p>";
            }
        } else {
            ...
            if ($tournament['registered_teams'] > 0) {
                ...
                echo "<p><a href='/admin/tournaments/registrations/check?tournament_id=$tournament_id&fix=1'>Reset the count to 0</a></p>";
            }
        }
    } else {
    ...
    if (isset($_GET['fix']) && $_GET['fix'] == 1) {
        ...
        if ($stmt->execute()) {
            ...
            echo "<p><a href='/admin/tournaments/registrations/check?tournament_id=$tournament_id'>Refresh</a></p>";
        } else {
