...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && empty($error_message)) {
    ...
    if (empty($team_name) || empty($team_captain)) {
        ...
        if (!empty($success_message)) {
            header("Location: /admin/tournaments?view_registrations=$tournament_id&msg=" . urlencode($success_message));
            exit();
        }
    }
}
    ...
    <section class="admin-section">
        <div class="container">
            <div class="tournament-header animate__animated animate__fadeIn">
                <div>
                    <a href="/admin/tournaments?view_registrations=<?php echo $tournament_id; ?>" class="btn btn-outline-light btn-back">
            ...
            <div class="admin-card animate__animated animate__fadeIn">
                <form method="post" action="">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="/admin/tournaments?view_registrations=<?php echo $tournament_id; ?>" class="btn btn-outline-light">
