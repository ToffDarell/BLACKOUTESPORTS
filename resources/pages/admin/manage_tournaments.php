...
if (isset($_GET['direct_delete_reg'])) {
    ...
    echo "<script>window.location = '/admin/tournaments?view_registrations=$tournament_id';</script>";
    exit();
}
...
if (isset($_GET['delete_id'])) {
    ...
    header("Location: /admin/tournaments?msg=Tournament deleted successfully");
    exit();
}
...
if (isset($_GET['view_registrations'])) {
    ...
    if (!$tournament_details) {
        header("Location: /admin/tournaments?msg=Tournament not found");
        exit();
    }
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/admin/tournaments/add">Tournaments</a>
                        </li>
        ...
        <div class="container">
            ...
            <?php if (isset($_GET['view_registrations'])): ?>
                ...
                <div class="tournament-header animate__animated animate__fadeIn">
                    <div>
                        <a href="/admin/tournaments" class="btn btn-outline-light btn-back">
                    ...
                    <div>
                        <a href="/admin/tournaments/edit?id=<?php echo $tournament_details['id']; ?>" class="btn btn-warning">
                            <i class="fas fa-edit me-2"></i> Edit Tournament
                        </a>
                        <a href="/admin/tournaments?clear_all_registrations=<?php echo $tournament_details['id']; ?>" class="btn btn-danger ms-2" onclick="return confirm('WARNING: This will delete ALL registrations for this tournament. This cannot be undone. Continue?');">
                            ...
                            <div class="col-lg-6">
                                <div class="registration-card">
                                    ...
                                    <div class="registration-actions">
                                        <a href="/admin/tournaments/registrations/edit?tournament_id=<?php echo $tournament_details['id']; ?>&registration_id=<?php echo isset($reg['id']) ? $reg['id'] : 0; ?>&team=<?php echo urlencode($reg['team_name']); ?>" class="btn btn-sm btn-warning action-btn">
                                        ...
                                        <a href="/admin/tournaments?direct_delete_reg=<?php echo isset($reg['id']) ? $reg['id'] : 0; ?>&tid=<?php echo $tournament_details['id']; ?>" class="btn btn-sm btn-danger action-btn" onclick="return confirm('Are you sure you want to delete this registration?');">
            ...
            <?php else: ?>
                ...
                <div class="d-flex justify-content-center mb-4 animate__animated animate__fadeIn">
                    <div class="btn-group admin-action-btns" role="group" aria-label="Tournament Admin Actions">
                        <a href="/admin/tournaments/add" class="btn btn-outline-light">
                            <i class="fas fa-plus-circle me-2"></i> Add Tournament
                        </a>
                        <a href="/admin/tournaments" class="btn btn-danger active">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admin/tournaments?view_registrations=<?php echo $tournament['id']; ?>" class="btn btn-sm btn-info action-btn">
                                            <i class="fas fa-users"></i> Registrations
                                        </a>
                                        <a href="/admin/tournaments/edit?id=<?php echo $tournament['id']; ?>" class="btn btn-sm btn-warning action-btn">
    ...
    <script>
        function confirmDelete(tournamentId) {
            if (confirm("Are you sure you want to delete this tournament? This will also delete all registrations for this tournament.")) {
                window.location.href = "/admin/tournaments?delete_id=" + tournamentId;
            }
        }
