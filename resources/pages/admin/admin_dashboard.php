...
$query = "SELECT reservation_id, user_id, computer_number, reservation_date, start_time, end_time FROM reservations WHERE reservation_date = CURDATE() OR reservation_date = CURDATE() + INTERVAL 1 WEEK";
$result = $conn->query($query);
