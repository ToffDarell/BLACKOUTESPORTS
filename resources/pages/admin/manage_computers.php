...
<head>
    ...
    <link rel="stylesheet" href="/css/manage_computer.css">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/admin/computers">Computers</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card computer-card <?php echo $statusClass; ?> animate__animated animate__fadeIn">
                                ...
                                <div class="card-footer d-flex justify-content-between bg-dark text-white border-top border-secondary">
                                    ...
                                    <a href="/admin/computers?delete=<?php echo $computer['computer_number']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure you want to delete this computer?');">
    ...
    <div class="modal fade" id="addComputerModal" tabindex="-1" aria-labelledby="addComputerModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/admin/computers" method="post">
