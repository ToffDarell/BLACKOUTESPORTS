...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_FILES["image"]["size"] > 0) {
        ...
        $target_dir = APP_ROOT . '/public/' . $upload_dir;
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
            ...
            if (!empty($tournament['image']) && file_exists(APP_ROOT . '/public/' . $tournament['image'])) {
                unlink(APP_ROOT . '/public/' . $tournament['image']);
            }
    ...
    if ($stmt->execute()) {
        header("Location: /admin/tournaments?msg=Tournament updated successfully");
        exit();
    }
    $stmt->close();
}
        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-center mb-4 animate__animated animate__fadeIn">
                <div class="btn-group admin-action-btns" role="group" aria-label="Tournament Admin Actions">
                    ...
                    <a href="/admin/tournaments" class="btn btn-outline-light">
            ...
            <div class="tournament-form animate__animated animate__fadeInUp">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-flex justify-content-between mt-5">
                        <a href="/admin/tournaments" class="btn btn-secondary">
