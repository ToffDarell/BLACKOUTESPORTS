                ...
                <div class="col-lg-8 mx-auto animate__animated animate__fadeIn">
                        ...
                        <table class="pricing-table">
                            ...
                            <tbody>
                                ...
                                <tr class="highlight">
                                    ...
                                    <td><s class="text-muted">â‚±150</s> â‚±130</td>
                                    <td><s class="text-muted">â‚±150</s> â‚±125</td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="calculator animate__animated animate__fadeIn">
                        ...
                        <div class="price-display">
                            <div>Your Total:</div>
                            <div id="total-price">â‚±<?php echo $is_member ? '25' : '30'; ?></div>
                            <?php if ($is_member): ?>
