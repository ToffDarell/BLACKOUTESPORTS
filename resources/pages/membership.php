                    ...
                    <div class="pricing-card">
                        ...
                        <div class="hourly-rates mb-4">
                            <div class="info-badge">
                                ...
                                <strong>Member Rate: â‚±20/hour</strong> (Regular Rate: â‚±30/hour)
                                <div class="mt-2 text-danger">Save â‚±10 per hour!</div>
                            </div>
                        </div>
                    ...
                    <div class="modal-content bg-dark">
                        ...
                        <div class="modal-body">
                            <form id="membershipForm" method="POST" action="/process_membership.php" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Membership Fee: â‚±200</label>
