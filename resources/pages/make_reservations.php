...
<head>
    ...
    <link rel="stylesheet" href="/css/make_reservations.css">
                ...
                <div class="form-section">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="alert payment-alert mb-3">
                            ...
                            <strong>Total Amount: <span id="payment-amount">â‚±0</span></strong><br>
    ...
    <script>
        ...
        function calculateTotal() {
            ...
            if (hoursSelect.value === '') {
                ...
                paymentAmountDisplay.textContent = 'â‚±0';
                return;
            }
            ...
            paymentAmountDisplay.textContent = `â‚±${total}`;
            
            // Highlight the savings if member
            if (isMember) {
                const savings = regularTotal - memberTotal;
                totalDisplay.innerHTML = `â‚±${memberTotal} <span class="text-success ms-2">(Saved â‚±${savings})</span>`;
            }
            
            // Highlight the special promo price for 5 hours
            if (hours === 5) {
                if (isMember) {
                    totalDisplay.innerHTML = `â‚±${memberTotal} <span class="text-success ms-2">(Promo price! Was â‚±150)</span>`;
                } else {
                    totalDisplay.innerHTML = `â‚±${regularTotal} <span class="text-success ms-2">(Promo price! Was â‚±150)</span>`;
                }
            }
        }
